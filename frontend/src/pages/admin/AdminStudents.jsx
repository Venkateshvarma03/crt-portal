...
import { LayoutDashboard, Layers, Users, GraduationCap, CalendarCheck, ClipboardList, Code2, BarChart3, PieChart, Bell, Settings, Search } from 'lucide-react'
...
function AdminStudents() {
  ...
  return (
    <DashboardLayout
      navItems={navItems}
      topbarProps={{ welcomeText: 'All Students', subText: 'Complete list of students across all batches.', userName: profile.name, userRole: profile.designation || 'TPO' }}
    >
      <div className="bg-white rounded-xl border border-[#f1f5f9] p-4 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-sm font-semibold text-gray-800">Students ({students.length})</h3>
